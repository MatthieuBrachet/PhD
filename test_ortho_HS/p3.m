...
for pl=1:kN,
    aa(10,pl)=fun_cs20(pl);
end
nhs2=3;mhs2=1;
fun_cs31=sph(nhs2,mhs2,x_cs,y_cs,z_cs);
for pl=1:kN,
    aa(11,pl)=conj(fun_cs31(pl));
end
for pl=1:kN,
    aa(12,pl)=fun_cs31(pl);
end
nhs2=3;mhs2=2;
fun_cs32=sph(nhs2,mhs2,x_cs,y_cs,z_cs);
for pl=1:kN,
    aa(13,pl)=conj(fun_cs32(pl));
end
for pl=1:kN,
    aa(14,pl)=fun_cs32(pl);
end
nhs2=3;mhs2=3;
fun_cs33=sph(nhs2,mhs2,x_cs,y_cs,z_cs);
for pl=1:kN,
    aa(15,pl)=conj(fun_cs33(pl));
end
for pl=1:kN,
    aa(16,pl)=fun_cs33(pl);
end
%%%%%%%%%%
rank(aa)
%%%%%%%%%%
