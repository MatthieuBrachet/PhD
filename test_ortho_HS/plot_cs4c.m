...
hold on;
%%
gtfI=text(0.4,0.5,'{\fontsize{18}(I)}');
% set(gtfI,'Size',1);
%
% FACE II
%for i=1:2,
...
plot(xc(:,1)+1,yc(:,1),'--','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
%
plot(xc(2,:)+1,yc(2,:)); hold on;
%
% plot(xc(:,2)+1,yc(:,2),'-','Color','green','Linewidth',4); hold on;
plot(xc(:,2)+1,yc(:,2),'-.','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
%%%
%end
text(0.3+1,0.5,'{\fontsize{18}(II)}');
% FACE III
plot(xc(1,:)+2,yc(1,:),'-'); hold on;
%plot(xc(:,1)+2,yc(:,1),'Color','blue','Linewidth',4); hold on;
plot(xc(:,1)+2,yc(:,1),':','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
plot(xc(2,:)+2,yc(2,:),'Color','black','Linewidth',4); hold on;
% plot(xc(:,2)+2,yc(:,2),'Color','yellow','Linewidth',4); hold on;
plot(xc(:,2)+2,yc(:,2),':','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
% text(0.25+2,0.5,'PANEL (III)');
text(0.3+2,0.5,'{\fontsize{18}(III)}');
% FACE IV
plot(xc(1,:)-1,yc(1,:),'Color','black','Linewidth',4); hold on;
% plot(xc(:,1)-1,yc(:,1),'Color','magenta','Linewidth',4); hold on;
plot(xc(:,1)-1,yc(:,1),'--','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
plot(xc(2,:)-1,yc(2,:),'-'); hold on;
% plot(xc(:,2)-1,yc(:,2),'Color','cyan','Linewidth',4); hold on;
plot(xc(:,2)-1,yc(:,2),'-.','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
text(0.3-1,0.5,'{\fontsize{18}(IV)}');
% FACE V
%for i=1:2,
% plot(xc(1,:),yc(1,:)+1,'Color','cyan','Linewidth',4); hold on;
plot(xc(1,:),yc(1,:)+1,'-.','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
plot(xc(:,1),yc(:,1)+1,'-'); hold on;
% plot(xc(2,:),yc(2,:)+1,'-','Color','green','Linewidth',4); hold on;
plot(xc(2,:),yc(2,:)+1,'-.','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
% plot(xc(:,2),yc(:,2)+1,'-','Color','yellow','Linewidth',4); hold on;
plot(xc(:,2),yc(:,2)+1,':','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
%end
% text(0.15,0.5+1,'PANEL (V)');
text(0.4,0.5+1,'{\fontsize{18}(V)}');
% FACE VI
%for i=1:2,
% plot(xc(1,:),yc(1,:)-1,'Color','magenta','Linewidth',4); hold on;
plot(xc(1,:),yc(1,:)-1,'--','Color',[0.5 0.5 0.5],'Linewidth',4); hold on;
% plot(xc(:,1),yc(:,1)-1,'-','Color','blue','Linewidth',4); hold on;
plot(xc(:,1),yc(:,1)-1,':','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
% plot(xc(2,:),yc(2,:)-1,'-','Color','red','Linewidth',4); hold on;
plot(xc(2,:),yc(2,:)-1,'--','Color',[0.2 0.2 0.2],'Linewidth',4); hold on;
plot(xc(:,2),yc(:,2)-1,'-'); hold on;
%end
% text(0.15,0.5-1,'PANEL (VI)');
text(0.3,0.5-1,'{\fontsize{18}(VI)}');
% FACE VI'PANEL (VI)');
axis([-1.5 3.5 -1.5 2.5]);
