...
To a parameter $\psi(\theta)$ given by \eqref{eq:fct_galewsky} 
...
Numerical results of the height $h$ at times $5$, $10$ and $15$ days are given in figure \ref{fig:W5 snapshot} with a grid $32 \times 32 \times 6$. Numerical conservations are represented on Fig. \ref{fig:W5 conservation}.
...
\right.
\end{equation}
with $h_0=10^{4}\si{m}$ and $u_{\lambda} = u_{max} \psi(\theta)$ with $\psi$ given by \eqref{eq:fct_galewsky}.
...
\caption{Numerical vorticity of the barotropic instability at day 6 with differents mesh. $32 \times 32 \times 6$ (top), $64 \times 64 \times 6$ (2nd panel) and $128 \times 128 \times 6$ (bottom).}
