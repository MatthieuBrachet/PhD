...
using three grids. 
% M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET
% The decreasing accuracy from $4$ to $3$ is attributed to the loss of computer accuracy near $0$.
...
%\hline 
%\end{tabular}
%\caption{Hermitian scheme applied to an exponential decaying solution of the LSWE. The final time is 1.5 hour and $H=10$ meters.}
%\label{table:4}
%\end{table}
\begin{figure}
...
To the given 
parameter function $\theta \mapsto \varphi(\theta)=\exp \left( \dfrac{1}{(\theta-\theta_0)(\theta-\theta_1)} \right)$ with $\theta_0 \leq \theta \leq \theta_1$ and $\varphi(\theta)=0$ in the other cases, 
...
%\end{table}
\begin{figure}
\includegraphics[scale=.5]{rate_lswe1.png}
\caption{Hermitian scheme applied to an exponential decaying solution of the LSWE. The final time is 1.5 hour and $H=10$ meters.}
\label{table:4}
\end{figure}
% M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET M. BRACHET
...
\begin{figure}[ht!]
\includegraphics[scale=0.4]{ref_7368007944_conservationA.png}
\includegraphics[scale=0.4]{ref_7368007944_conservationBdiv.png}\\
\includegraphics[scale=0.4]{ref_7368007944_conservationBvort.png}
\caption{Numerical conservation of steady state geostrophic flow in direction of $\alpha=\pi/4$ on  $32 \times 32 \times 6$ grid after $5$ model days of simulation.}
\label{fig:W2 conservation alpha=pi/4}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht!]
\includegraphics[scale=0.4]{ref_7368015325_conservationB.png}
...
\caption{Numerical results of the barotropic instability at day 6 with differents mesh. $32 \times 32 \times 6$ (top), $64 \times 64 \times 6$ (2nd panel) and $128 \times 128 \times 6$ (bottom).}
