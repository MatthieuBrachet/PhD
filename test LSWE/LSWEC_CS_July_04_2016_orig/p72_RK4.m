...
while t<Tmax & iter<itermax
    ...
    %% Filtrage
    hnf_fI=ht_fI;     hnf_fII=ht_fII;    hnf_fIII=ht_fIII;
    hnf_fIV=ht_fIV;   hnf_fV=ht_fV;      hnf_fVI=ht_fVI;
    
    vnf_fI=vt_fI;     vnf_fII=vt_fII;    vnf_fIII=vt_fIII;
    vnf_fIV=vt_fIV;   vnf_fV=vt_fV;      vnf_fVI=vt_fVI;
    ...
    htnew_fI    = hnf_fI   + ddt/6 * (K1h_fI   + 2*K2h_fI   + 2*K3h_fI   + K4h_fI);
    htnew_fII   = hnf_fII  + ddt/6 * (K1h_fII  + 2*K2h_fII  + 2*K3h_fII  + K4h_fII);
    htnew_fIII  = hnf_fIII + ddt/6 * (K1h_fIII + 2*K2h_fIII + 2*K3h_fIII + K4h_fIII);
    htnew_fIV   = hnf_fIV  + ddt/6 * (K1h_fIV  + 2*K2h_fIV  + 2*K3h_fIV  + K4h_fIV);
    htnew_fV    = hnf_fV   + ddt/6 * (K1h_fV   + 2*K2h_fV   + 2*K3h_fV   + K4h_fV);
    htnew_fVI   = hnf_fVI  + ddt/6 * (K1h_fVI  + 2*K2h_fVI  + 2*K3h_fVI  + K4h_fVI);


    vtnew_fI    = vnf_fI   + ddt/6 * (K1v_fI   + 2*K2v_fI   + 2*K3v_fI   + K4v_fI);
    vtnew_fII   = vnf_fII  + ddt/6 * (K1v_fII  + 2*K2v_fII  + 2*K3v_fII  + K4v_fII);
    vtnew_fIII  = vnf_fIII + ddt/6 * (K1v_fIII + 2*K2v_fIII + 2*K3v_fIII + K4v_fIII);
    vtnew_fIV   = vnf_fIV  + ddt/6 * (K1v_fIV  + 2*K2v_fIV  + 2*K3v_fIV  + K4v_fIV);
    vtnew_fV    = vnf_fV   + ddt/6 * (K1v_fV   + 2*K2v_fV   + 2*K3v_fV   + K4v_fV);
    vtnew_fVI   = vnf_fVI  + ddt/6 * (K1v_fVI  + 2*K2v_fVI  + 2*K3v_fVI  + K4v_fVI);
...
figure(5)
plot_cs11(n,nn,(h_fI-ht_fI)./nrmref,(h_fII-ht_fII)./nrmref,(h_fIII-ht_fIII)./nrmref,(h_fIV-ht_fIV)./nrmref,(h_fV-ht_fV)./nrmref,(h_fVI-ht_fVI)./nrmref);
