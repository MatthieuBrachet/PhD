...
\begin{itemize}
\item chapitre a restructurer,
\item partie 1 : équation de transport (linéaire),
\item grouper les tests NM et NJ dans une meme sous section
\item nombreuses figures a refaire, notament les coupes en traits épais et attention au point de départ des solutions exactes
\item partie 2 : équations non linéaires
\item partie sur les équations de conservations en général
\item résultats numériques récents.
\end{itemize}
