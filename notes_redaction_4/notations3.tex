...
Les vecteurs $(U^k)_{-N/2+1 \leq k \leq N/2}$ est une base orthonormée de $\mathbb{R}^N$ pour le produit scalaire usuel.
...
%% ******************* CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION ********** CORRECTION *****

On défini $D_{2P} \in \mathbb{M}_N(\mathbb{R})$ la matrice associée à l'opérateur $\delta_{2P,x}$ :
\begin{equation}
