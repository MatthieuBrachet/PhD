...
elseif strcmp(scheme,'compact6')==1
    ...
    p_div=alpha*eye(na,na)+bbeta*(J+J^(na-1));
    pg=sparse(p_div);
...
elseif strcmp(scheme,'explicite4')==1
    ...
    a=4/3;
    b=-1/3;
    k=(-a/(2*dxi))*J+(-b/(4*dxi))*J^2+...
    (a/(2*dxi))*J^(na-1)+(b/(4*dxi))*J^(na-2);
    kg=sparse(k);
    pg=speye(na,na);
    
elseif strcmp(scheme,'explicite6')==1
    J=diag(ones(na-1,1),-1);
    J(1,end)=1;
    ...
    b=-3/5;
    c=1/10;
    k=(-a/(2*dxi))*J+(-b/(4*dxi))*J^2+(-c/(6*dxi))*J^3+...
    (a/(2*dxi))*J^(na-1)+(b/(4*dxi))*J^(na-2)+(c/(6*dxi))*J^(na-3);
    kg=sparse(k);
    pg=speye(na,na);
    
elseif strcmp(scheme,'explicite8')==1
    J=diag(ones(na-1,1),-1);
    J(1,end)=1;
    ...
    c=8/35;
    d=-1/35;
    k=(-a/(2*dxi))*J+(-b/(4*dxi))*J^2+(-c/(6*dxi))*J^3+(-d/(8*dxi))*J^4+...
      (a/(2*dxi))*J^(na-1)+(b/(4*dxi))*J^(na-2)+(c/(6*dxi))*J^(na-3)+(d/(8*dxi))*J^(na-4);
    kg=sparse(k);
    pg=speye(na,na);
