...
N=[16 32 64];
dx=2*pi*radius./(4*N);
e1=[4.3512e-3 3.4013e-4 1.8727e-5];
e2=[5.3203e-3 5.0150e-4 3.9000e-5];
e3=[1.4743e-2 1.8541e-3 1.9349e-4];

e1=[4.2910e-2 1.0220e-2 1.9720e-3];
e2=[2.3945e-3 1.2153e-5 1.5016e-7];
e3=[2.5354e-3 1.9082e-5 1.1257e-6];
