function [div_fI,div_fII,div_fIII,div_fIV,div_fV,div_fVI]=...
    div72b(mfunfI,mfunfII,mfunfIII,mfunfIV,mfunfV,mfunfVI,n,nn)
global na nb;
global radius;
global xx yy deltab;
global alfa beta;
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5b(x_fII(i,j));
        xwk2=fun7b(x_fII(i,j));
...
for i=1:nn,
    for j=1:nn,
      xwk1=fun5b(x_fIV(i,j));
      xwk2=fun7b(x_fIV(i,j));
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5b(x_fVI(i,j));
        xwk2=fun7b(x_fVI(i,j));      
...
for i=1:nn,
    for j=1:nn,
      xwk1=fun5b(y_fIII(i,j));
      xwk2=fun7b(y_fIII(i,j));
...
for i=1:nn,
    for j=1:nn,
      xwk1=fun5b(y_fVI(i,j));
      xwk2=fun7b(y_fVI(i,j));
      getaIIb_VI(i,j,1)= 0;
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5b(z_fII(i,j));
        xwk2=fun7b(z_fII(i,j));
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5b(z_fIV(i,j));
        xwk2=fun7b(z_fIV(i,j));
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5b(z_fIII(i,j));
        xwk2=fun7b(z_fIII(i,j));
