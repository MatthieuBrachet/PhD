...
\begin{equation}
\mathbf{g'}_{\xi} = \dfrac{\partial}{\partial \xi} \left( R_f \mathbf{x} \right) = R_f \dfrac{\partial \mathbf{x}}{\partial \xi}  = \mathbf{g}_{\xi}
\end{equation}
...
\begin{tabular}{|c|c|c|}
\hline
\textbf{Panel} & Coord. Gnomoniques $(X,Y)$ & \textbf{Base } $\left( \mathbf{g}_{\xi}, \mathbf{g}_{\eta} \right)$\\

\hline
\hline
$I$ & $X=\dfrac{y}{x} \text{, } Y=\dfrac{z}{x}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-y \\ x(1+Y^2) \\ -yY
...
\hline
$II$ & $X=-\dfrac{x}{y} \text{, } Y=\dfrac{z}{y}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-y(1+Y^2) \\ x \\ xY
\end{pmatrix} \text{ et } \mathbf{g}_{\eta} = \dfrac{1+Y^2}{\delta^2} \begin{pmatrix}
zX \\ -z \\ y(1+X^2)
\end{pmatrix}$ \\
...
\hline
$III$ & $X=-\dfrac{y}{x} \text{, } Y=-\dfrac{z}{x}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-y \\ x(1+Y^2) \\ yY
\end{pmatrix} \text{ et } \mathbf{g}_{\eta} = \dfrac{1+Y^2}{\delta^2} \begin{pmatrix}
-z \\ -zX \\ x(1+X^2)
\end{pmatrix}$ \\
...
\hline
$IV$ & $X=-\dfrac{x}{y} \text{, } Y=\dfrac{z}{y}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-y(1+Y^2) \\ x \\ -xY
\end{pmatrix} \text{ et } \mathbf{g}_{\eta} = \dfrac{1+Y^2}{\delta^2} \begin{pmatrix}
-zX \\ z \\ -y(1+X^2)
\end{pmatrix}$ \\
...
\hline
$V$ & $X=\dfrac{y}{z} \text{, } Y=\dfrac{x}{z}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-yY \\ z(1+Y^2) \\ -y
\end{pmatrix} \text{ et } \mathbf{g}_{\eta} = \dfrac{1+Y^2}{\delta^2} \begin{pmatrix}
-z(1+X^2) \\ xX \\ x
\end{pmatrix}$ \\
...
\hline
$VI$ & $X=-\dfrac{y}{z} \text{, } Y=-\dfrac{x}{z}$ & $\mathbf{g}_{\xi} = \dfrac{1+X^2}{\delta^2} \begin{pmatrix}
-yY \\ -z(1+Y^2) \\ y
\end{pmatrix} \text{ et } \mathbf{g}_{\eta} = \dfrac{1+Y^2}{\delta^2} \begin{pmatrix}
-z(1+X^2) \\ -xX \\ x
\end{pmatrix}$ \\
...
%}
\end{center}
\caption{Coordonnées gnomoniques et base $\left( \mathbf{g}_{\xi}, \mathbf{g}_{\eta} \right)$ sur chaque panel.}
...
\begin{tabular}{|c|c|c|}
\hline
\textbf{Panel} & \textbf{Tenseur métrique } $\mathbf{G}$ & \textbf{Base } $\left( \mathbf{g}^{\xi}, \mathbf{g}^{\eta} \right)$\\

\hline
\hline
$I$ &  & $\mathbf{g}^{\xi} = \dfrac{1}{x(1+X^2)}\begin{pmatrix}
-X \\ 1 \\ 0
...
\cline{1-1} \cline{3-3}
$II$ &  & $\mathbf{g}^{\xi} = \dfrac{1}{y(1+X^2)}\begin{pmatrix}
-1 \\ -X \\ 0
...
\cline{1-1} \cline{3-3}
$III$ &  & $\mathbf{g}^{\xi} = \dfrac{1}{x(1+X^2)}\begin{pmatrix}
-X \\ 1 \\ 0
\end{pmatrix} \text{ et } \mathbf{g}^{\eta} = \dfrac{1}{x(1+Y^2)}\begin{pmatrix}
-Y \\ 0 \\ -1
\end{pmatrix}$ \\
...
\cline{1-1} \cline{3-3}
$IV$ &  & $\mathbf{g}^{\xi} = \dfrac{1}{y(1+X^2)}\begin{pmatrix}
-1 \\ -X \\ 0
\end{pmatrix} \text{ et } \mathbf{g}^{\eta} = \dfrac{1}{y(1+Y^2)}\begin{pmatrix}
0 \\ -Y \\ -1
\end{pmatrix}$ \\
...
\cline{1-1} \cline{3-3}
$V$ &  & $\mathbf{g}^{\xi} = \dfrac{1}{z(1+X^2)}\begin{pmatrix}
0 \\ 1 \\ -X
...
\cline{1-1} \cline{3-3}
$VI$ & \multirow{-5}{*}[2.5cm]{$a^2 \dfrac{(1+X^2)(1+Y^2)}{\delta^4} \begin{pmatrix}
1+X^2 & -XY \\ -XY & 1+Y^2
\end{pmatrix}$} & $\mathbf{g}^{\xi} = \dfrac{1}{z(1+X^2)}\begin{pmatrix}
0 \\ -1 \\ -X
\end{pmatrix} \text{ et } \mathbf{g}^{\eta} = \dfrac{1}{z(1+Y^2)}\begin{pmatrix}
-1 \\ 0 \\ -Y
\end{pmatrix}$ \\
...
%}
\end{center}
\caption{Tenseur métrique et base $\left( \mathbf{g}^{\xi}, \mathbf{g}^{\eta} \right)$ sur chaque panel.}
\label{tab: base g^xi g^eta}
\end{table}
