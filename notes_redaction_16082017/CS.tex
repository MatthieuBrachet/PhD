...
\end{figure}
%%%%%%%%%%%%%%%%% FAIRE DE MEME POUR UN SECOND CERCLE
Soit $\overline{\mathbf{x}} \in \mathbb{S}_a^2$, il existe un plan tangent à la sphère noté $\mathbb{T}_{\overline{\mathbf{x}}}\mathbb{S}_a^2$. Il est engendré par les vecteurs $\mathbf{e}_{\alpha}$ et $\mathbf{e}_{\beta}$ (Voir figure \ref{fig: e_alpha et e_beta}) donnés par :
