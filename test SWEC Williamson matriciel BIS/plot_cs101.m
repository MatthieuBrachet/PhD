function []=plot_cs101(n,nn,funfIe,funfIIe,funfIIIe,funfIVe,funfVe,funfVIe,v)
...
contour(lam_I,the_I,funfIe.*(funfIe>0),v,'k-');hold on;axis([lmin lmax temin temax]);
contour(lam_I,the_I,funfIe.*(funfIe<0),v,'k--');hold on;

%% -- FACE II
[lam_II,the_II,xwk]=cart2sph(x_fII,y_fII,z_fII);
contour(lam_II,the_II,funfIIe.*(funfIIe>0),v,'k-');hold on;
contour(lam_II,the_II,funfIIe.*(funfIIe<0),v,'k--');hold on;
...
contour(lam_IIIb,the_IIIb,funfIIIeb.*(funfIIIeb>0),v,'k-');hold on;
contour(lam_IIIb,the_IIIb,funfIIIeb.*(funfIIIeb<0),v,'k--');hold on;

%% -- FACE IV
[lam_IV,the_IV,xwk]=cart2sph(x_fIV,y_fIV,z_fIV);
contour(lam_IV,the_IV,funfIVe.*(funfIVe>0),v,'k-');hold on;
contour(lam_IV,the_IV,funfIVe.*(funfIVe<0),v,'k--');hold on;
...
contour(lam_V_qI,the_V_qI,funfVsI.*(funfVsI>0),v,'k-'); hold on;
contour(lam_V_qI,the_V_qI,funfVsI.*(funfVsI<0),v,'k--'); hold on;
...
contour(lam_V_qII,the_V_qII,funfVsII1.*(funfVsII1>0),v,'k-');hold on;
contour(lam_V_qII,the_V_qII,funfVsII1.*(funfVsII1<0),v,'k--');hold on;
...
contour(lam_V_a,the_V_a,funfVa.*(funfVa>0),v,'k-');hold on;
contour(lam_V_a,the_V_a,funfVa.*(funfVa<0),v,'k--');hold on;

lam_V_b=lam_V_qIII(1:(nn+1)/2,:)-pi;
the_V_b=the_V_qIII(1:(nn+1)/2,:);
funfVb=funfVsIII(1:(nn+1)/2,:);
contour(lam_V_b,the_V_b,funfVb.*(funfVb>0),v,'k-');hold on;
contour(lam_V_b,the_V_b,funfVb.*(funfVb<0),v,'k--');hold on;
...
contour(lam_V_qIV1-2*pi,the_V_qIV,funfVsIV1.*(funfVsIV1>0),v,'k-');hold on;
contour(lam_V_qIV1-2*pi,the_V_qIV,funfVsIV1.*(funfVsIV1<0),v,'k--');hold on;
...
contour(lam_VI_qI,the_VI_qI,funf.*(funf>0),v,'k-');hold on;
contour(lam_VI_qI,the_VI_qI,funf.*(funf<0),v,'k--');hold on;
...
contour(lam_VI_qII,the_VI_qII,funfVIsII1.*(funfVIsII1>0),v,'k-');hold on;
contour(lam_VI_qII,the_VI_qII,funfVIsII1.*(funfVIsII1<0),v,'k--');hold on;
...
contour(lam_VI_a,the_VI_a,funfVIa.*(funfVIa>0),v,'k-');hold on;
contour(lam_VI_a,the_VI_a,funfVIa.*(funfVIa<0),v,'k--');hold on;

lam_VI_b=lam_VI_qI((nn+1)/2:nn,:)-pi;
the_VI_b=the_VI_qIII((nn+1)/2:nn,:);
funfVIb=funfVIsIII((nn+1)/2:nn,:);
contour(lam_VI_b,the_VI_b,funfVIb.*(funfVIb>0),v,'k-');hold on;
contour(lam_VI_b,the_VI_b,funfVIb.*(funfVIb<0),v,'k--');hold on;
...
contour(lam_VI_qIV,the_VI_qIV,funfVIsIV.*(funfVIsIV>0),v,'k-');hold on;
contour(lam_VI_qIV,the_VI_qIV,funfVIsIV.*(funfVIsIV<0),v,'k--');hold on;
