...
\begin{figure}[H]
\includegraphics[scale=0.3]{01-Dec-2015ref_7362994679_snapshot_test_1_nday_0.png}
\includegraphics[scale=0.3]{01-Dec-2015ref_7362994694_snapshot_test_1_nday_3.png}

\includegraphics[scale=0.3]{01-Dec-2015ref_7362994721_snapshot_test_1_nday_6.png}
\includegraphics[scale=0.3]{01-Dec-2015ref_7362994773_snapshot_test_1_nday_9.png}

\includegraphics[scale=0.3]{01-Dec-2015ref_7362994827_snapshot_test_1_nday_12.png}
\caption{Projection de la solution approchée au bout de 0, 3, 6, 9 et 12 jours pour le test de Nair et Machenhauer \cite{TBA}. $N=31$; $CFL = 0.7$; $(\lambda_p, \theta_p) = (\pi/4,\pi/4)$}
\label{SNAPSHOT}
\end{figure}
...
\begin{figure}[H]
\includegraphics[scale=0.3]{01-Dec-2015ref_7362996526_normerreur_test_1.png}
\includegraphics[scale=0.3]{01-Dec-2015ref_7362994773_normerreur_test_1.png}
\label{erreur_cfl=0.5}
\caption{courbe d'erreur $N=35$; $cfl=0.5$; $(\lambda_P, \theta_P) = (0,0)$ (gauche) et $(\lambda_P, \theta_P) = (\pi/4,\pi/4)$ (droite) pour le test de Nair et Machenhauer \cite{TBA}}
\end{figure}



%\begin{figure}[H]
%\includegraphics[scale=0.3]{01-Dec-2015ref_7362776620_normerreur_test_2.png}
%\includegraphics[scale=0.3]{01-Dec-2015ref_7362745425_normerreur_test_2.png}
%\label{erreur_cfl=0.5}
%\caption{courbe d'erreur $N=35$; $cfl=0.05$; $(\lambda_P, \theta_P) = (0,0)$ (gauche) et $(\lambda_P, \theta_P) = (\pi/4,\pi/4)$ (droite) pour le test de Nair et Machenhauer \cite{TBA}}
%\end{figure}
...
\hline
$100$ & $6.996 (-6)$ & $4.7925$ & $3.2964 (-5)$ & $4.7879$ & $2.6738 (-4)$ & $4.5687$\\
\hline
$150$ & $1.0231 (-6)$ & $4.7804$ & $5.1609 (-6)$ & $4.6109$ & $5.3299 (-5)$ & $4.0102$
\end{tabular}
\caption{Analyse de convergence pour le test de Nair et Machenhauer \cite{TBA}. $N=31$; $CFL = 0.7$; $(\lambda_p, \theta_p) = (0,0)$}
\end{figure}
