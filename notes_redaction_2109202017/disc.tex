...
Dans son article \cite{Lele1991}, S. K. Lele présente une méthode permettant d'approcher la dérivée en un point en ajoutant une partie implicite au schéma de la forme \eqref{eq:explicite_dx}. Dans ce chapitre, nous ne considérons que les schémas à 4 points implicites. Nous définissons $\sigma_{3,x}$ par :
...
et si $u$ est une fonction suffisament régulière, alors pour tout $0 \leq i \leq N-1$, on a 
\begin{equation}
