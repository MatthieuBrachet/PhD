function []=plot_cs20m(n,nn,funfIe,funfIIe,funfIIIe,funfIVe,funfVe,funfVIe,mmin,mmax,pas)
...
dat=0;
 ...
 lam_I=lam_I+2*pi*(lam_I<-eps)-pi; 
 lam_II=lam_II+2*pi*(lam_II<-eps)-pi;
 lam_III=lam_III+2*pi*(lam_III<-eps)-pi;
 lam_IV=lam_IV+2*pi*(lam_IV<-eps)-pi;
 lam_V=lam_V+2*pi*(lam_V<-eps)-pi;
 lam_VI=lam_VI+2*pi*(lam_VI<-eps)-pi;
...
% face I-II-III-IV
%% ************************************************************************
lmin=-180;lmax=180;temin=-90;temax=90;
