...
\begin{equation}
\mathcal{F}_{2F,x} = \gsum_{k=0}^F a_k \dfrac{\tau^k + \tau^{-k}}{2} = S(\tau)
\label{eq:ftr}
\end{equation}
...
\begin{eqnarray*}
\mathcal{F}_{2F,x} = \gsum_{k=0}^F a_k \dfrac{\tau_x^k + \tau_x^{-k}}{2}  = S(\tau_x)\\
\mathcal{F}_{2F,y} = \gsum_{k=0}^F a_k \dfrac{\tau_y^k + \tau_y^{-k}}{2} = S(\tau_y) \\
\end{eqnarray*}
