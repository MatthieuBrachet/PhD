...
\end{equation}
en fonction de $N$, le paramètre du maillage. La fonction $h$ choisit est 
\begin{equation}
...
La table \eqref{tab:diff_ftr} permet de confirmer que plus l'ordre du filtre est élevé, moins la fonction est affectée par l'opérateur de filtrage.