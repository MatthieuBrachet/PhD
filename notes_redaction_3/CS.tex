...
\left\lbrace
\begin{array}{rcl}
\dfrac{\partial \mathbf{g}^{\xi}}{\partial \xi} & = & - \Gamma_{\xi, \xi}^{\xi} \mathbf{g}^{\xi} - \Gamma_{\xi, \eta}^{\xi} \mathbf{g}^{\eta}\\
\dfrac{\partial \mathbf{g}^{\eta}}{\partial \xi} & = & - \Gamma_{\xi, \xi}^{\eta} \mathbf{g}^{\xi} - \Gamma_{\xi, \eta}^{\eta} \mathbf{g}^{\eta}\\
\dfrac{\partial \mathbf{g}^{\eta}}{\partial \eta} & = & - \Gamma_{\eta, \eta}^{\eta} \mathbf{g}^{\eta} - \Gamma_{\eta, \xi}^{\eta} \mathbf{g}^{\xi}\\
\dfrac{\partial \mathbf{g}^{\xi}}{\partial \eta} & = & - \Gamma_{\eta, \eta}^{\xi} \mathbf{g}^{\eta} - \Gamma_{\eta, \xi}^{\xi} \mathbf{g}^{\xi}\\
\end{array}
\right.
\end{equation}
\end{proposition}
