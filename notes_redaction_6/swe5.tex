...
\end{center}
\caption{Cas de la montagne isolée \cite{Williamson1992}, le paramètre de la Cubed-Sphere est $N=32$. On choisit $CFL=0.9$.  On représente $\bh$ aux temps $t=5$, $10$ et $15$ jours.}
...
\end{center}
\caption{Cas test de Rossby-Haurwitz à 7 et 14 jours. Le paramètre de la Cubed-Sphere est $N=80$. Le pas de temps est donné par $\CFL=0.9$. On représente $\bh$ à différents temps. Les résultats obtenus sont identiques à ceux obtenus dans la littérature \cite{Chen2008, Ullrich2011}}
