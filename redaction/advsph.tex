...
\subsubsection{du BUMP de D. L. Williamson}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{ref_7366098351_erreur_test_0.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{ref_7366098300_erreur_test_0.png}
...
\hline 
maxi. filtre d'ordre 6 & $501.9189$& $834.3534$ & $9754.9533$  \\ 
\hline 
...
L'objectif de ce test est de présenter une solution plus réaliste. On construit deux vortex placés au pôles $P$ et au point diamétralement opposé. Ce test est présenté dans l'article de 2002 de R. D. Nair et B. Machenhauer dans \cite{Nair2002}.
