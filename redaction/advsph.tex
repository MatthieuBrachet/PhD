...
\subsubsection{Test du BUMP de D. L. Williamson}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{ref_7366098248_solexacte_test_0.png}
\includegraphics[scale=0.3]{ref_7366098351_solapprochee_test_0.png}
\caption{Test du Bump - $\alpha = 0$ - $N=40$ - $CFL=0.9$ - solution à $t=0$ (gauche) et à $t=12 jours$ (droite) }
\label{table adv1}
\end{center}
\end{figure}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.4]{ref_7366098351_erreur_test_0.png}
\includegraphics[scale=0.3]{ref_7366098351_normerreur_test_0.png}
\caption{Test du Bump - $\alpha = 0$ - $N=40$ - $CFL=0.9$ - à $t=12 jours$ localisation spatiale de l'erreur relative $( h^n - h(t^n) )$ (gauche) et erreur relative en norme (droite) }
\label{table adv2}
\end{center}
\end{figure}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.4]{ref_7366098300_erreur_test_0.png}
\includegraphics[scale=0.3]{ref_7366098300_normerreur_test_0.png}
\caption{Test du Bump - $\alpha = 3 \pi /4$ - $N=40$ - $CFL=0.9$ - à $t=12 jours$ localisation spatiale de l'erreur relative $( h^n - h(t^n))$ (gauche) et erreur relative en norme (droite) }
\label{table adv3}
\end{center}
\end{figure}
...
\hline 
maxi. filtre d'ordre 6 & $501.9189$& $834.3534$ & $975.9533$  \\ 
\hline 
maxi. filtre d'ordre 2 & $69.0705$ & $126.0255$ & $223.3778$  \\ 
\hline 
\end{tabular} 
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{ref_7366146685_solapprochee_test_1.png}
\includegraphics[scale=0.3]{ref_7366146685_erreur_test_1.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.4]{ref_7366146760_solapprochee_test_1.png}
\includegraphics[scale=0.5]{ref_7366146760_erreur_test_1.png}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.3]{ref_7366146685_normerreur_test_1.png}
\includegraphics[scale=0.3]{ref_7366146760_normerreur_test_1.png}
