function [div_fI,div_fII,div_fIII,div_fIV,div_fV,div_fVI]=...
    div67(mfunfI,mfunfII,mfunfIII,mfunfIV,mfunfV,mfunfVI,n,nn)
global mm na nb;
global radius;
...
for i=1:nn,
    for j=1:nn,
        xwk1=fun5(x_fII(i,j)); %%% ICI ERREUR, CF P73.M: CORRECTION
        xwk2=fun7(x_fII(i,j));  %%% ICI ERREUR, CF P73.M: CORRECTION
