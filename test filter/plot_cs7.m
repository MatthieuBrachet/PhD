...
% classic plot en projection stéréographique couleur
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
surf(lam_VI_qIV1,the_VI_qIV,funfVIsIV1);hold on;
%axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
epsilon=10^-7;
plot3(lam_Ia((nn+1)/2,:),the_Ia((nn+1)/2,:),funfIea(1,:)+epsilon,'k','LineWidth',1.25); hold on;
%plot3(lam_Ia((nn+1)/2,:),the_Ia((nn+1)/2,:),1+0.01,'k','LineWidth',1.25); hold on;
plot3(lam_Ia(:,1),the_Ia(:,1),funfIea(:,1)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_Ia(:,nn),the_Ia(:,nn),funfIea(:,nn)+epsilon,'k','LineWidth',1.25); hold on;
%
plot3(lam_II(1,:),the_II(1,:),funfIIe(1,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_II(nn,:),the_II(nn,:),funfIIe(nn,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_II(:,1),the_II(:,1),funfIIe(:,1)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_II(:,nn),the_II(:,nn),funfIIe(:,nn)+epsilon,'k','LineWidth',1.25); hold on;
%
plot3(lam_III(1,:),the_III(1,:),funfIIIe(1,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_III(nn,:),the_III(nn,:),funfIIIe(nn,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_III(:,1),the_III(:,1),funfIIIe(:,1)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_III(:,nn),the_III(:,nn),funfIIIe(:,nn)+epsilon,'k','LineWidth',1.25); hold on;
%
plot3(lam_IV(1,:),the_IV(1,:),funfIVe(1,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_IV(nn,:),the_IV(nn,:),funfIVe(nn,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_IV(:,1),the_IV(:,1),funfIVe(:,1)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_IV(:,nn),the_IV(:,nn),funfIVe(:,nn)+epsilon,'k','LineWidth',1.25); hold on;
%
plot3(lam_Ib(1,:),the_Ib(1,:),funfIeb(1,:)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_Ib(:,1),the_Ib(:,1),funfIeb(:,1)+epsilon,'k','LineWidth',1.25); hold on;
plot3(lam_Ib(:,nn),the_Ib(:,nn),funfIeb(:,nn)+epsilon,'k','LineWidth',1.25); hold on;
