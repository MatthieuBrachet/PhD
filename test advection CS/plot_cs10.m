function []=plot_cs10(n,nn,funfIe,funfIIe,funfIIIe,funfIVe,funfVe,funfVIe)
...
%
contour(lam_Ia,the_Ia,funfIea);hold on;axis([lmin lmax temin temax umin umax]);
contour(lam_II,the_II,funfIIe);hold on;axis([lmin lmax temin temax umin umax]);
contour(lam_III,the_III,funfIIIe);hold on;axis([lmin lmax temin temax umin umax]); 
contour(lam_IV,the_IV,funfIVe);hold on;axis([lmin lmax temin temax umin umax]);
contour(lam_Ib,the_Ib,funfIeb);hold on;axis([lmin lmax temin temax umin umax]);
%
% face V
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
...
contour(lam_V_a,the_V_a,funfVa);hold on;axis([lmin lmax temin temax umin umax]);
...
contour(lam_V_b,the_V_b,funfVb);hold on;axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
...
contour(lam_V_qII,the_V_qII,funfVsII1);hold on;axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
contour(lam_V_qIV1,the_V_qIV,funfVsIV1);hold on;axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% FIN TRACE FACE V  %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FACE VI
...
%  funfVIa=funfVIsI((nn+1)/2:nn,(nn+1)/2:-1:1); % JPC
 ...
 contour(lam_VI_a,the_VI_a,funfVIa);hold on;axis([lmin lmax temin temax umin umax]);
% % patche a droite du dessin de (2*pi)-pi/4 a 2*pi
 lam_VI_b=lam_VI_qI(1:(nn+1)/2,:)+2*pi;
 the_VI_b=the_VI_qI(1:(nn+1)/2,:);
 funfVIb=funfVIsI(nn:-1:(nn+1)/2,:);
 %funfVIb=funfVIsI((nn+1)/2:-1:1,:);
 contour(lam_VI_b,the_VI_b,funfVIb);hold on;axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
...
contour(lam_VI_qII,the_VI_qII,funfVIsII1);hold on;axis([lmin lmax temin temax umin umax]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
contour(lam_VI_qIV1,the_VI_qIV,funfVIsIV1);hold on;axis([lmin lmax temin temax umin umax]);
view(3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
