...
title('solution exacte')
if save_graph==1
    print('-dpng', ['solexacte_test' num2str(coef) '_100cfl' num2str(cfl*100) '.png'])
end
...
if save_graph==1
    print('-dpng', ['solapprochee_test' num2str(coef) '_100cfl' num2str(cfl*100) '.png'])
end
...
if save_graph==1
    print('-dpng', ['erreur_test' num2str(coef) '_100cfl' num2str(cfl*100) '.png'])
end
...
if save_graph==1
    print('-dpng', ['normerreur_test' num2str(coef) '_100cfl' num2str(cfl*100) '.png'])
end
