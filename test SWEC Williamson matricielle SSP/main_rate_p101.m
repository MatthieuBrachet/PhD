...
errh1=max(max(abs([err1h_fI, err1h_fII, err1h_fIII, err1h_fIV, err1h_fV, err1h_fVI])));
...
errv1=max(max(max(abs([err1v_fI, err1v_fII, err1v_fIII, err1v_fIV, err1v_fV, err1v_fVI]))));
...
errh2=max(max(abs([err2h_fI, err2h_fII, err2h_fIII, err2h_fIV, err2h_fV, err2h_fVI])));
...
errv2=max(max(max(abs([err2v_fI, err2v_fII, err2v_fIII, err2v_fIV, err2v_fV, err2v_fVI]))));
...
set(gcf,'PaperPositionMode','auto')
set(hFig, 'Position', [50 50 1000 500])
plot_err(n_init,err1h_fI./err2h_fI(1:2:end,1:2:end),err1h_fII./err2h_fII(1:2:end,1:2:end),err1h_fIII./err2h_fIII(1:2:end,1:2:end)...
    ,err1h_fIV./err2h_fIV(1:2:end,1:2:end),err1h_fV./err2h_fV(1:2:end,1:2:end),err1h_fVI./err2h_fVI(1:2:end,1:2:end))
caxis([-1 1])
colorbar
