...
\section{Schémas aux différences finies 1D}

\subsection{Opérateurs centré d'ordre 2}
...
\section{Schémas Hermitien 1D}

\subsection{Opérateurs centré d'ordre 2}

\subsection{\'Ecriture matricielle}

\subsection{Algorithme de Shermann-Morisson-Woodbury}
...
\section{Schémas Hermitien 2D}

\subsection{Opérateurs "mat" et "vect"}

\subsection{Opérateur Hermitien 2D}
