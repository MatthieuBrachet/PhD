function [div_fI,div_fII,div_fIII,div_fIV,div_fV,div_fVI]=...
    div80(mfunfI,mfunfII,mfunfIII,mfunfIV,mfunfV,mfunfVI,n,nn)
global mm na nb;
global radius;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ETAPE 2: ASEMBLAGE DE LA DIVERGENCE PAR PRODUIT SCALAIRE AVEC VECTEURS
% CONTRAVARIANTS GXI ET GETA SUR CHAQUE FACE.
div_fI=zeros(nn,nn);
for i=1:nn,
    for j=1:nn,
...
[div_fI(1:nn,1:nn),div_fII(1:nn,1:nn),div_fIII(1:nn,1:nn),div_fIV(1:nn,1:nn),div_fV(1:nn,1:nn),div_fVI(1:nn,1:nn,1)]=...
    ds80(uwk_I,uwk_II,uwk_III,uwk_IV,uwk_V,uwk_VI,n,nn);
