...
% LES ETAPES 1 ET 2 SONT IDENTIQUES AU CALCUL DU GRADIENT STANDARD
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ETAPE1 1: ASSEMBLAGE DES 6 RESEAUX
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ASSEMBLAGE DES DERIVEES PARTIELLES D/DXI ET D/DETA SUR CHAQUE PANEL
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ETAPE 3 - ASSEMBLAGE DES DERIVEES PARTIELLES D/DXI ET D/DETA SUR CHAQUE PANEL
% EN FONCTION DES DERIVEES ALPHA/BETA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:nn,
    for j=1:nn,
        ...
        grxi_I(i,j)=xwk_xi*dg_alfa(i,j,1);
        greta_I(i,j)=xwk_eta*dg_beta(i,j,1);
...
for i=1:nn,
    for j=1:nn,
        ...
        xwk_xi  = (1/sqrt(1+yy(i,j)^2))*xwk;
        xwk_eta = (1/sqrt(1+xx(i,j)^2))*xwk;
        grxi_II(i,j)=xwk_xi*dg_alfa(i,j,2);
        greta_II(i,j)=xwk_eta*dg_beta(i,j,2);
...
for i=1:nn,
    for j=1:nn,
        ...
        xwk_xi  = (1/sqrt(1+yy(i,j)^2))*xwk;
        xwk_eta = (1/sqrt(1+xx(i,j)^2))*xwk;
        grxi_III(i,j)=xwk_xi*dg_alfa(i,j,3);
        greta_III(i,j)=-xwk_eta*dg_beta(i,j,3);
...
for i=1:nn,
    for j=1:nn,
        ...
        xwk_xi  = (1/sqrt(1+yy(i,j)^2))*xwk;
        xwk_eta = (1/sqrt(1+xx(i,j)^2))*xwk;
        grxi_IV(i,j)=xwk_xi*dg_alfa(i,j,4);
        greta_IV(i,j)=-xwk_eta*dg_beta(i,j,4);
...
for i=1:nn,
    for j=1:nn,
        ...
        xwk_xi  = (1/sqrt(1+yy(i,j)^2))*xwk;
        xwk_eta = (1/sqrt(1+xx(i,j)^2))*xwk;
        grxi_V(i,j)=xwk_xi*dg_alfa(i,j,5);
        greta_V(i,j)=xwk_eta*dg_beta(i,j,5);
...
for i=1:nn,
    for j=1:nn,
        ...
        xwk_xi  = (1/sqrt(1+yy(i,j)^2))*xwk;
        xwk_eta = (1/sqrt(1+xx(i,j)^2))*xwk;
        grxi_VI(i,j)=-xwk_xi*dg_alfa(i,j,6);
        greta_VI(i,j)=xwk_eta*dg_beta(i,j,6);
...
%     ds73(uwk_I,uwk_II,uwk_III,uwk_IV,uwk_V,uwk_VI,n,nn);
% % COMPONENT 2
