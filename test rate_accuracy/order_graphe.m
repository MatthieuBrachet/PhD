...
%% Nair-Machenhauer
% e1=[1.4218e-3 5.2599e-4 1.9646e-4 3.4719e-5 9.9724e-6 1.2117e-6];
% e2=[6.0198e-3 2.4308e-3 9.7746e-4 1.7531e-4 4.7225e-5 6.2853e-6];
% e3=[4.5356e-2 1.8245e-2 7.6475e-3 1.6499e-3 4.6740e-4 6.7620e-5];
%% Nair-Jablonowski
...
% %% courbes...
hlff1=plot(tt,lsq1,'--k');
set(hlff1,'LineWidth',2.0);

hlff2=plot(tt,lsq2,'-k');
set(hlff2,'LineWidth',2.0);

hlff3=plot(tt,lsq3,'-.k');
set(hlff3,'LineWidth',2.0);
...
%% texte
ht=text('Position',[4.93,-8.6,0],'String','N=128');
set(ht,'FontSize',12);
% ht=text('Position',[4.1,-8.8,0],'String','\Deltat=2.5min');
% set(ht,'FontSize',12);

ht=text('Position',[5.18,-7.52,0],'String','N=64');
set(ht,'FontSize',12);
% ht=text('Position',[4.38,-7.8,0],'String','\Deltat=5min');
% set(ht,'FontSize',12);

ht=text('Position',[5.42,-6.6,0],'String','N=32');
set(ht,'FontSize',12);
