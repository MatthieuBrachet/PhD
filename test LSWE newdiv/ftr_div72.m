function [funftI,funftII,funftIII,funftIV,funftV,funftVI]=...
    ftr_div72(funfI,funfII,funfIII,funfIV,funfV,funfVI,n,nn)
global mm na nb deta;
global alfa beta;
global betacr;
global alfa1;
global ftr_div;
...
% FILTRAGE
for jline1=1:nn,
   va_fI(1:na,jline1)=ftr_div*va_fI(1:na,jline1);
end
...
for j=1:nn-1 % LOOP ON THE ETA OF FACE V
 ...
 % FILTRAGE
for iline1=1:nn,
   vb_fI(iline1,1:nb)=vb_fI(iline1,1:nb)*ftr_div;
end
% TRANSFERT FACE I+III
for iline1=1:nn,
...
% FILTRAGE
for jline1=1:nn,
   va_fII(1:na,jline1)=ftr_div*va_fII(1:na,jline1);
end
...
for i=1:nn-1 % LOOP ON THE XI OF FACE VI. i= order of encountering !!!
 ...
 % FILTRAGE
for iline1=1:nn,
   vb_fII(iline1,1:nb)=vb_fII(iline1,1:nb)*ftr_div;
end
% TRANSFERT FACE II+IV
for iline1=1:nn,
...
% FILTRAGE
for jline1=1:nn,
   va_fV(1:na,jline1)=ftr_div*va_fV(1:na,jline1);
end
% TRANSFERT FACE V+VI
for jline1=1:nn,
...
for j=1:nn-1, % LOOP ON THE ETA-LINES OF FACE I. j= order of encountering !!!
 ...
 % FILTRAGE
for iline1=1:nn,
   vb_fV(iline1,1:nb)=vb_fV(iline1,1:nb)*ftr_div;
end
% TRANSFERT FACE V+VI
for iline1=1:nn,
