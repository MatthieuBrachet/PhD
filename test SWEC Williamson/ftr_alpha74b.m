function [funftI,funftII,funftIII,funftIV,funftV,funftVI]=...
    ftr_alpha74b(funfI,funfII,funfIII,funfIV,funfV,funfVI,n,nn)
global na;
global alfa beta;
global  betacr;
global alfa1;
...
% FILTRAGE
for jline1=1:nn,
   va_fI(1:na,jline1)=ftr1*va_fI(1:na,jline1);
end
...
% FILTRAGE
for jline1=1:nn,
   va_fII(1:na,jline1)=ftr1*va_fII(1:na,jline1);
end
...
% FILTRAGE
for jline1=1:nn,
   va_fV(1:na,jline1)=ftr1*va_fV(1:na,jline1);
end
% TRANSFERT FACE V+VI
for jline1=1:nn,
