...
% ----------------------------------
global scheme
global opt_ftr opt_ftr1 opt_detec
% -------------------------------------------------------------------------
global n nn;
global mm na nb;
global radius;
...
elseif strcmp(opt_ftr1,'redonnet2')==1
    f0=1/2; 
    f1=1/4;
    f2=0;
    f3=0;
...
elseif strcmp(opt_ftr1,'redonnet4')==1
    f0=10/16; 
    f1=4/16;
    f2=-1/16;
    f3=0;
...
elseif strcmp(opt_ftr1,'redonnet6')==1
    f0=44/64; 
    f1=15/64;
    f2=-6/64;
    f3=1/64;
...
elseif strcmp(opt_ftr1,'redonnet8')==1
    f0=186/256; 
    f1=56/256;
    f2=-28/256;
    f3=8/256;
...
elseif strcmp(opt_ftr1,'redonnet10')==1
    f0=772/1024; 
    f1=210/1024;
    f2=-120/1024;
    f3=45/1024;
...
elseif strcmp(opt_ftr1,'bogey6')==1
    d0=0.234810479761700;
    d1=-.199250131285813;
    d2=0.120198310245186;
    d3=-.049303775636020;
...
sh15=sh14*sh1;
sh1i5=sh1i4*sh1i;
ftr1=f0*eye(na)+f1*(sh1+sh1i)+f2*(sh12+sh1i2)+f3*(sh13+sh1i3)+f4*(sh14+sh1i4)+f5*(sh15+sh1i5);
ftr1=sparse(ftr1);

%% INTEGRALE CORRIGEE
disp('calcul des poids...')
nhs_max=2;%.125*(nn-1)^2-1; % combre d'harmoniques à corriger
