function []=plot_cs8(n,nn,funfIe,funfIIe,funfIIIe,funfIVe,funfVe,funfVIe)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
surfc(lam_Ia,the_Ia,funfIea); hold on;
surfc(lam_II,the_II,funfIIe); hold on;
surfc(lam_III,the_III,funfIIIe);hold on; 
surfc(lam_IV,the_IV,funfIVe);hold on; 
surfc(lam_Ib,the_Ib,funfIeb); hold on;
% face V
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%55
...
surfc(lam_V_a,the_V_a,funfVa);hold on;
...
surfc(lam_V_b,the_V_b,funfVb);hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
...
surfc(lam_V_qIII+pi,the_V_qIII,funfVsIII);
colorbar;hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
surfc(lam_V_qII,the_V_qII,funfVsII1);hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
surfc(lam_V_qIV1,the_V_qIV,funfVsIV1);hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% FIN TRACE FACE V  %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FACE VI
...
max(lam_VI_qI)
%surfc(lam_VI_qI,the_VI_qI,funfVIsI(nn:-1:1,:));hold on;
% % 2 TRACES POUR L'ORIGINE DES LAMBDA
% % patch a gauche de lambda=0 a pi/4
...
surfc(lam_VI_qIII+pi,the_VI_qIII,funfVIsIII);
colorbar;hold on;
% break;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
surfc(lam_VI_qII,the_VI_qII,funfVIsII1);hold on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
surfc(lam_VI_qIV1,the_VI_qIV,funfVIsIV1);hold on;
shading interp;
% lam_III(1:nn,1)'
% (lam_V_qI(1:nn,1)+pi)'
